    ...
    <div class="box_content">
      <div class="product_desc clearfix">
        ...
        <div class="product_details">
          ...
          <p>{{ trans('content.dulcolaxdrops_3') }}</p>
          <ul>
            <li><span>{{ trans('content.dulcolaxdrops_4') }}</span></li>
            <li><span>{{ trans('content.dulcolaxdrops_5') }}</span></li>
          </ul>
          <div class="pd_buttons">
            <a class="learnMore hash_reload" href="#produktdetails">{{ trans('content.common_1') }}</a><a href="#buy-now" rel="tab11" class="buy hash_reload">{{ trans('content.common_2') }}</a>
          </div>
          <span class="pd_links">
      ...
      <div id="tabs-detail" class="clearfix" name="tab-area">
        ...
        <div class="tabs_content clearfix">
          ...
          <div id="learn-more" class="tab_content clearfix">
            ...
            <h2>{{ trans('content.dulcolaxdrops_15') }}</h2>
            <p>{{ trans('content.dulcolaxdrops_16') }}</p>
            <p>{{ trans('content.dulcolaxdrops_17') }}</p>
            <ul>
                <li><span>{{ trans('content.dulcolaxdrops_18') }}</span></li>
                <li><span>{{ trans('content.dulcolaxdrops_19') }}</span></li>
            </ul>
            <p>{{ trans('content.dulcolaxdrops_20') }}</p>
            <p>{{ trans('content.dulcolaxdrops_21') }}</p>
          </div>
