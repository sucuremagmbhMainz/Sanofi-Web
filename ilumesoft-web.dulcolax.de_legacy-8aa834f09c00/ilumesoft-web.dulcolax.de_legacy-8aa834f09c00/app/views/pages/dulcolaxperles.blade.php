    ...
    <div class="box_content">
      <div class="product_desc clearfix">
        ...
        <div class="product_details">
          ...
          <p>{{ trans('content.dulcolaxdrops_32') }}</p>
          <ul>
            <li><span>{{ trans('content.dulcolaxdrops_33') }}</span></li>
            <li><span>{{ trans('content.dulcolaxdrops_34') }}</span></li>
          </ul>
          <div class="pd_buttons">
            <a class="learnMore hash_reload" href="#learn-more">{{ trans('content.common_1') }}</a><a href="#buy-now" rel="tab10" class="buy hash_reload">{{ trans('content.common_2') }}</a>
          </div>
          <span class="pd_links">
      ...
      <div id="tabs-detail" class="clearfix" name="tab-area">
        ...
        <div class="tabs_content clearfix">
          ...
          <div id="learn-more" class="tab_content clearfix">
            ...
            <p>{{ trans('content.dulcolaxdrops_43') }}</p>
            <p>{{ trans('content.dulcolaxdrops_44') }}</p>
            <ul>
                <li><span>{{ trans('content.dulcolaxdrops_45') }}</span></li>
                <li><span>{{ trans('content.dulcolaxdrops_46') }}</span></li>
            </ul>
            <p>{{ trans('content.dulcolaxdrops_47') }}</p>
          </div>
