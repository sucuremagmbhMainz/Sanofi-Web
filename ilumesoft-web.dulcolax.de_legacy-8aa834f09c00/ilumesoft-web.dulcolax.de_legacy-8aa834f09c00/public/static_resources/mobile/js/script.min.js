...
$(document).ready(function() {
    ...
    function setDesktop() {
        ...
        sliderVar = $('.faq .grid_row').bxSlider({
            minSlides: 4,
            maxSlides: 4,
            slideWidth: 180,
            pager: false,
    ...
    if ($('.slider').length != 0) {
        ...
        mainSlider = $('.slider').bxSlider({
            ...
            onSlideBefore: function($slideElement, oldIndex, newIndex) {
                ...
                if (oldIndex == 0 && (player.getPlayerState() == YT.PlayerState.PLAYING || player.getPlayerState() == YT.PlayerState.BUFFERING)) {
                    player.pauseVideo();
                }
                /*if (newIndex == 0){
                    $('.bx-viewport video').css('visibility', 'visible');
                } else {
                    $('.bx-viewport video')[0].pause();
                    $('.bx-viewport video').css('visibility', 'hidden');
                }*/
            }
        });
    }
...
(function($) {
    ...
    $.fn.disclaimerize = function() {
        ...
        var setEvent = function(){
            $("a.disclaimer-popup").click(function(e){
                e.preventDefault();
                open($(this).attr("href"));
            });
