...
$resolutions   = array(1920, 1024, 969, 968, 768, 710, 321, 320); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "static_resources/mobile/images/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
