...
class File extends Model
{
    ...
    static $_filenameOnce = false;
    public static function setFilenameOnce($useFilenameOnce)
    {
        self::$_filenameOnce = $useFilenameOnce;
    }

    public static function getFilenameOnce() {
        $tmpFilename = self::$_filenameOnce;
        self::$_filenameOnce = false;
    ...
    public function fromPost($uploadedFile)
    {
        ...
        $oneTimeFilename = self::getFilenameOnce();
        $this->file_name = $oneTimeFilename !== false ? $oneTimeFilename : $uploadedFile->getClientOriginalName();
