...
class FileUpload extends FormWidgetBase
{
    ...
    protected function prepareVars()
    {
        ...
        $this->vars['finalFilename'] = $this->finalFilename !== false ? $this->finalFilename : '';
    ...
    public function onUpload()
    {
        try {
            ...
            if (($finalFilename = $this->getConfig('finalFilename', false)) !== false) {
                File::setFilenameOnce($finalFilename);
            }
