...
var node=_ref3;node.textContent=file.name;var fileUploadParent=node.closest('.field-fileupload');if(fileUploadParent!==null){var finalFilename=fileUploadParent.getAttribute('data-final-filename');if(finalFilename!==undefined&&finalFilename!==null&&finalFilename!==''){node.textContent=finalFilename;}}}
